...
while True:
    for event in pygame.event.get():
        if COINS >= 5:  # Если число монет равно 5, увеличиваем скорость
            if SPEED != 10: # Увеличиваем только до 10
                SPEED += 1
    ...
    if collected:
        ...
        op = random.randint(1, 5) # Присваеваем разную ценность монете
        COINS += op  # Увеличиваем счет монет
